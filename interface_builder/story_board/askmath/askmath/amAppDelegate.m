...
//
//basically, if not using storyboard , we have to do the following
//   - create the window and set it to self.window
//  - instantiate root view controller from storyboard and set to window
//  - call window makeKeuAndVisible
...
//    UIStoryboard* testBoard = [UIStoryboard storyboardWithName:@"Test" bundle:nil];
//    [self.window setRootViewController: [testBoard instantiateInitialViewController]];

    //[[UIApplication sharedApplication] setStatusBarStyle:UIStatusBarStyleLightContent];

    
    //configure the root view controller here 
    return YES;
}
